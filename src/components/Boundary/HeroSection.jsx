  ...
  return (
    <div className="relative w-full h-[90vh] overflow-hidden">
      <div className="-mt-16 overflow-hidden">
        <h1 className="w-[45vw] text-center text-[6vw] leading-[1.2] overflow-hidden tracking-normal  font-sans font-[900] break-words ml-[50%] translate-x-[-50%]">
          Think creative, Do effective
        </h1>
        <div className="-mt-5">
          <input
            className="w-[32vw] h-[40px] bg-[#DADADA] rounded-md pl-4 ml-[50%] translate-x-[-50%] text-[16px]"
            type="text"
        ...
        <Marquee className="my-2" speed={30}>
          {landingImgRow1.map((item, index) => (
            <div
              ...
              key={index}
            >
              <img className="w-full h-full scale-110" src={item} />
            </div>
          ))}
        </Marquee>
