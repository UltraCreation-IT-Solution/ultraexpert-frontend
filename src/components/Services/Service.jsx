...
export const ServiceCard = ({ item }) => {
  ...
  return (
    <div className="relative shrink-0 w-full xs:w-[300px] md:w-[350px] rounded-xl bg-white border-[0.6px] border-[#bebebe] border-solid shadow-lg md:mb-0 pb-4">
      ...
      <div className="px-2 md:px-[0.8vw] pt-2 md:pt-0">
        ...
        <div className="text-sm line-clamp-3 md:mb-[1vw]">{item?.title}</div>
