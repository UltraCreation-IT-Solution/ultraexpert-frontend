            ...
            <form onSubmit={handleSubmit} className="flex flex-col">
              ...
              <div className="flex justify-center md:justify-end md:mx-20 mb-8">
                <button
                  type="submit"
                  className={`${
                    loading ? "cursor-not-allowed bg-gray-400" : "bg-inherit text-white"
                  }  cursor-pointer px-6 py-2 text-base md:text-lg font-semibold text-blue-500 rounded-md shadow-md`}
                >
                  Submit
                </button>
              </div>
