    ...
    <>
      ...
      <div className="bg-[#F2F2F2] px-[2vw] py-[3vw] mt-20">
        ...
        <div className="mt-6 md:mt-[3vw] flex items-center gap-[2vw] overflow-x-scroll">
          {hotTopics.map((temp,index) => (
            <div key={index} className="relative flex items-center justify-center w-[150px] h-[200px] md:w-[280px] md:h-[300px] shrink-0 object-cover rounded-md ">
              <img
                src={temp.img}
      ...
      <div>
        ...
        <div className="mt-6 lg:mt-10 px-[8vw] md:px-[10vw] flex flex-wrap justify-center gap-[2vw]">
          {allBlogsArray.length===0?<div>no blogs</div> :
        ...
        <div className="text-[#575757]">
          ...
          <div className="mt-3 text-xs flex items-center gap-2">
            ...
            <div className="flex items-center flex-wrap gap-2">
              {tags?.map((item,index) => (
                <div key={index} className="text-[10px] shrink-0 border border-solid border-slate-300 px-2 py-1 rounded-xl cursor-pointer">
