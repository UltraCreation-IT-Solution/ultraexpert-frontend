...
import { IoEyeSharp, IoPersonAdd, IoSettings, IoLocationOutline } from "react-icons/io5";
        ...
        <div className="relative flex h-[240px] items-end mt-14 bg-red-400">
          <div className="w-36 min-h-36 max-h-36 bg-[#1E2237] text-white text-center rounded-l-xl">
            <img
              ...
              alt=""
            />
            <div className="bg-[#009BD6] w-6 h-6 rounded-md text-center text-xs rotate-45 absolute top-20 left-12">2</div>
