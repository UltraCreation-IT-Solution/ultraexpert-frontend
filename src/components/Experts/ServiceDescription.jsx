    ...
    <div className=''>
      ...
      <div className='w-[85%] m-auto mt-[80px] py-[2vw]'>  
        ...
        <div className='p-[1vw] mt-[1vw]'>
          <h1 className='text-[1.5vw] font-extrabol mb-[1.5vw]'>Web & Application development</h1>
        ...
        <div className=' p-[1vw] mt-[1vw] w-2/4'>
          ...
          <p className='text-[1vw] text-[#615f5f]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit tempore officiis omnis nam possimus voluptatibus sit dolores eveniet atque nemo mollitia nobis quisquam delectus, minus nesciunt quos itaque earum doloremque eius in? Accusantium aspernatur dicta illo, doloremque enim fugit ipsa.</p> 
        </div>
