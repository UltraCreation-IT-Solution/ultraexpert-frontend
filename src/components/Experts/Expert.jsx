...
export const ProfileCards = () => {
  return profileObj.map((item, index) => {
    return (
      <div
        key={index}
        className="relative flex flex-col w-[27vw] h-[28vw] sm:w-[20vw] sm:h-[22vw] md:w-[18vw] md:h-[20vw] rounded-md md:rounded-lg justify-center items-center shadow-lg my-[2vw] md:my-[0.65vw]  "
      >
        <div className="absolute top-[0.6vw] right-[0.3vw] z-10 text-white text-[2.8vw] sm:text-[2.4vw] md:text-[2.2vw] lg:text-[2vw] py-[0.4vw] px-[0.4vw] rounded-full bg-black/30 border-[0.18vw] sm:border-[0.12vw] border-white flex items-center border-solid shadow-lg ">
          <FaRegHeart />
        </div>
        <img
        ...
        />
        <img
          className="absolute top-[12%] sm:top-[14%] md:top-[12%] z-10 w-[8vw] h-[8vw] sm:w-[7vw] sm:h-[7vw] md:w-[6vw] md:h-[6vw] border-white border-solid border-[0.4vw] rounded-full object-cover"
          src={item.profile}
          alt="profile"
        />
        <div className=" absolute bottom-0 w-full h-2/3 bg-white px-[1.6vw]">
          <div className="mt-[1.6vw] sm:mt-[1.8vw] md:mt-[1vw] text-center flex flex-col gap-[0.6vw] justify-center text-[2vw] sm:text-[1.35vw] md:text-[1.2vw]">
            <h3 className=" shrink-0 h-[2vw] flex items-center justify-center mb-[-0.6vw] text-[2.2vw] sm:text-[1.35vw] md:text-[1.2vw]">
              {item.name}
            </h3>
            <p className="mb-0 mt-[0.4vw]  md:mt-0 font-light text-[2vw] sm:text-[1.25vw] md:text-[1.1vw] text-[#383838]">
              {item.designation}
            </p>
...
export const AllExperts = () => {
  return (
    <div className="relative w-full h-auto py-[3vw] px-[6vw] md:px-[10vw] flex flex-col">
      <div className="flex w-full justify-between">
        <div className="text-[3.8vw] sm:text-[2.8vw] md:text-[2vw] font-bold mb-[1.5vw]">
          Experts
        </div>
        <div className="flex gap-[1.4vw] pr-[4vw] sm:pr-[4vw] md:pr-[3.8vw]">
      ...
      <div className="w-full flex flex-wrap gap-[1.8vw] sm:gap-[1.4vw] md:gap-[1.1vw] pb-[2vw] justify-centerjada   items-center">
        <ProfileCards />
      </div>
    </div>
  );
