            ...
            <div className="flex gap-[3vw] sm:gap-0 sm:flex-col">
              ...
              <div className="mt-3 flex items-center gap-4">
                ...
                {localStorage.getItem("isExpert") ? (
                  <></>
                ) : (items.is_favorite ? (<div className="border border-solid border-slate-400 text-[10px] rounded-full px-3 py-0.5 flex items-center cursor-pointer gap-1"><FaMinus/> Added to Fav</div>) :(
